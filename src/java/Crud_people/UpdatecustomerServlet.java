...
public class UpdatecustomerServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        Customer c = cudb.getByCheckIdCustomer(cuid);
        
        session.setAttribute("mnlist", mnlist);
        session.setAttribute("genderlist", genderlist);
        
        session.setAttribute("cu", c);
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (!checkLimitDate(date)) {
           ...
           response.sendRedirect("updatecustomer?cuid="+cusid);
            ...
            try {
                ...
                Customer c1 = new Customer(cusid, cusfname, cuslname, email, phonenumber, address, d, gender, ml,network);
                cudb.updateCustomer(c1);
